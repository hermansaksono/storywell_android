...
public interface FitnessManagerInterface {
     ...
     * @param cacheExpiryDate The timestamp of the local storage's expiration date.
     * @return The GroupFitnessInterface object representing the fitness activities that begins at
     * startDate and ends on endDate.
     */
    GroupFitnessInterface getMultiDayFitness(Date startDate, Date endDate, Date cacheExpiryDate);
}
