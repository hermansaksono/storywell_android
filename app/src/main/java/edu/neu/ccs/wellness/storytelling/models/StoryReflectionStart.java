...
public class StoryReflectionStart implements StoryContent {
    private StoryPage page;

    // CONSTRUCTORS

    public StoryReflectionStart(int pageId, StoryInterface story,
    ...
    public ContentType getType() {
        return ContentType.REFLECTION_START;
    }
